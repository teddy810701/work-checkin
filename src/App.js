        ...
        <div style={styles.leftCol}>
          ...
          <div style={styles.panelCard}>
            <div style={styles.listHeader}>
              ...
              <button style={styles.addEmployeeSecondaryBtn} onClick={() => setShowAddModal(true)}>
                <span style={styles.addEmployeeSecondaryBtnIcon}>＋</span>
                新增員工
              </button>
            </div>
          </div>
...
const styles = {
  ...
  modalCancelBtn: {
    ...
    fontWeight: 800,
    cursor: "pointer",
    boxShadow: "inset 0 0 0 1px #dbe2ea",
    transition: "all 0.2s ease",
  },
  modalLoginBtn: {
    flex: 1,
  ...
  fullGreenBtn: {
    ...
    fontWeight: 900,
    cursor: "pointer",
    boxShadow: "0 14px 28px rgba(5,150,105,0.22)",
    transition: "all 0.2s ease",
  },
  fullOrangeBtn: {
    width: "100%",
